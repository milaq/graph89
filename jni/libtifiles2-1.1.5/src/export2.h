...
# define TIEXPORT2 __attribute__ ((visibility("default")))
...
#  if defined(TIFILES_EXPORTS)
#   define TIEXPORT2 __declspec(dllexport)
#  else
#   define TIEXPORT2 __declspec(dllimport)
#  endif

# elif defined(__MINGW32__)		// MinGW - GCC for Windows, (c) 2002 Kevin Kofler
#  if defined(TIFILES_EXPORTS)	// defined by the configure script
#   define TIEXPORT2 __declspec(dllexport)
#  else
#   define TIEXPORT2 __declspec(dllimport)
#  endif
