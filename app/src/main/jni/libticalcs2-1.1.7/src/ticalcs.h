...
#define update_start()		(void)0//handle->updat->start()
#define update_pbar()       (void)0//handle->updat->pbar()
#define update_label()      (void)0//handle->updat->label()
#define update_refresh()    (void)0//handle->updat->refresh()
#define update_stop()      (void)0// handle->updat->stop()
